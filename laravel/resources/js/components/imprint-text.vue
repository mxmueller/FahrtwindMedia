<template>
    <section class="cc_a_4 cc_jump-to-article text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto">
            ...
            <h1 class="title-font text-5xl pb-8 font-semibold cc_intro-font_animation text-center">Kontakt:
            </h1>
