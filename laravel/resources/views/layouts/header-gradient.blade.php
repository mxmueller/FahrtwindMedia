<header x-data="{ mobileMenuOpen : false }"
        ...
        <nav class="absolute md:relative top-16 left-0 md:top-0 z-20 md:flex flex-col md:flex-row md:space-x-6 font-semibold w-full md:w-auto bg-white shadow-md rounded-lg md:rounded-none md:shadow-none md:bg-transparent p-6 pt-0 md:p-0"
            ...
            <a data-aos="zoom-in-down" data-aos-delay="500" href="/home" class="ocip1 block py-1 md:text-white hover:underline cc_a_4">Home</a>
            <a data-aos="zoom-in-down" data-aos-delay="600" href="/team" class="ocip1 block py-1 md:text-white hover:underline cc_a_5">Team</a>
            <a data-aos="zoom-in-down" data-aos-delay="700" href="/impressum" class="ocip1 block py-1 md:text-white hover:underline cc_a_6">Impressum</a>
        </nav>
</header>