...
<body class="antialiased">
    ...
    <article class="px-6 h-screen intro">
        ...
        <div id="cc_conversation_banner" class="cc_gradient-bg w-1/6 p-5 rounded-lg shadow-lg text-white text-center animate-pulse">
    ...
    <article class="text-lg px-6 py-6 text-gray-600 mx-auto max-w-2xl h-screen cc_intro-text">
      ...
      <p class="text-7xl text-center">Hi! 👋</p>
      
      <div class="py-12 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="lg:text-center">
                    <h2 class="text-base text-indigo-600 font-semibold tracking-wide uppercase">Hi! wir sind Fahrwind
                        Media, ein</h2>
